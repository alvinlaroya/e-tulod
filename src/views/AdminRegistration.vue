  ...
  <div>
    <v-container style="padding: 20px; margin-top: -20px" fluid
      ...
      <span style="font-size: 13px"
        >Welcome to E-Tulod <router-link to="/dashboard">Admin Dashboard</router-link> / Admin Registration</span
      >
    </v-container>
    <v-container fluid>
...
export default {
  data: () => ({
    ...
    password: "",
    profile:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS8g1xgfONND3jpusoYg1XpV8o7gknHPTIMfA&usqp=CAU",
    show1: "",
  }),
              ...
              firebase
                ...
                .then(() => {
                  ...
                  this.$swal({
                    icon: "success",
                    title: "Saved!",
                    text: `${self.fname} ${self.lname} succesfully registered!`,
                  });
                  const user = {
                    firstName: this.fname,
                    middleName: this.mname,
